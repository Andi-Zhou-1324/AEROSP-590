...
#-----------------------------------------------------------
# This function calculates the 2D inviscid wall flux
# INPUTS: UL = interior state, as a 4x1 vector
#         gamma = ratio of specific heats (e.g. 1.4)
#         n = unit normal vector (2x1) pointing out of the domain
# OUTPUTS: F = numerical normal flux (4x1 vector)
#          smag = max wave speed estimate    
#-----------------------------------------------------------
def WallFlux(UL, gamma, n):
    rL  = UL[0];
    uL  = UL[1]/rL;
    vL  = UL[2]/rL;
    unL = uL*n[0] + vL*n[1];
